...
int main() {
    ...
    int A[N]; // массивы элементов
    int B[N];
    int* C[N * 2]; // массив адресов смещения элементов 
    ...
    __asm {
        ...
        mov edx, A[ecx * TYPE A] // помещаем элемент массива А в регистр (32 битный)
        cmp edx, B[ecx * TYPE B] // сравнииеваем
        ...
        xchg edx, B[ecx * TYPE B] // меняем местами элементы A и B массивов
